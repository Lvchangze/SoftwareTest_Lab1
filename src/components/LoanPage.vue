<template>
  <el-container>
    <div class="padd">
      <el-table class="table_head table_border" :data="loanList" size="small" border
                style="border-bottom: 0;padding:0">
        <el-table-column prop="iouNum" label="借据号" column-key="iouNum" align="center"
        ></el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button type="primary" v-on:click="gotoBillPage(scope.row.iouNum)">查看详情</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      loanList: [
        {
          iouNum: "6161754432644526488",//借据号
  ...
  methods: {
    gotoBillPage(iouNum) {
      console.log(iouNum)
      this.$store.commit('setCurrentIouNum', iouNum)
